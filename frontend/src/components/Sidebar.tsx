...
import { LayoutDashboard, List, LineChart, Settings, Sun, Moon, Shield, LogOut, TrendingUp, Activity, Menu, X, BarChart3, Gauge } from "lucide-react";
...
<aside className="w-64 h-screen hidden md:flex flex-col fixed left-0 top-0 z-40 bg-white dark:bg-[#0a0e1a] border-r border-slate-200 dark:border-slate-800/60 transition-transform duration-300">
{sidebarContent}
</aside>
</>
);
